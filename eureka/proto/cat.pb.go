...
func (*GetMyCatMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_cat_270ed5e29843525e, []int{0}
}
...
func (*MyCatResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cat_270ed5e29843525e, []int{1}
}
...
func init() { proto.RegisterFile("cat.proto", fileDescriptor_cat_270ed5e29843525e) }

var fileDescriptor_cat_270ed5e29843525e = []byte{
