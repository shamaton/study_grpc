...
func (*GetMyCatMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_cat_b14ec1f233efd247, []int{0}
}
...
func (*MyCatResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cat_b14ec1f233efd247, []int{1}
}
...
func init() { proto.RegisterFile("cat.proto", fileDescriptor_cat_b14ec1f233efd247) }

var fileDescriptor_cat_b14ec1f233efd247 = []byte{
